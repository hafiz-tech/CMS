  ...
  onPressSignUp() async {
    ...
    if (name == "") {
      ToastComponent.showDialog(AppLocalizations.of(context)!.enter_your_name,
          gravity: Toast.center, duration: Toast.lengthLong,backColor: Colors.red,textColor: Colors.white);
      return;
      ...
      ToastComponent.showDialog(
          ...
          duration: Toast.lengthLong,backColor: Colors.red,textColor: Colors.white);
      return;
    } else if (password == "") {
    ...
    if (signupResponse.result == false) {
      ...
      final parsed = signupResponse.message as Map<dynamic, dynamic>;
      ...
      ToastComponent.showDialog(message, gravity: Toast.center, duration: 3,backColor: Colors.red,textColor: Colors.white);
    } else {
      ToastComponent.showDialog(signupResponse.message,
          gravity: Toast.center, duration: Toast.lengthLong,backColor: Colors.green,textColor: Colors.white);
