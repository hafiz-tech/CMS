...
class HomePresenter extends ChangeNotifier {
  ...
  fetchBannerImages() async {
    var bannerResponse = await SlidersRepository().getBannerImages();
    bannerResponse.sliders!.forEach((slider) {
      bannerImageList.add(slider.photo);
    });
    isBannerInitial = false;
    notifyListeners();
  }
